...
%    unexpected results on unseen data due to overfitting.
    ...
    From \Cref{fig:validation} it is visible that overall the KernelNet performed best, the AE made continuous progress, while AutoRec and NCF quickly started to diverge.
